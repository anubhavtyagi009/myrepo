...
public class ClassReadingHistoryDataDTO {
    ...
    public ClassReadingHistoryDataDTO(Integer studentId, String letterLevel, String lastPassage, String category, BigDecimal accuracy, String proficiency, Integer fluency, Date assignmentDate, String notes) {
    ...
    public ClassReadingHistoryDataDTO() {
    }
