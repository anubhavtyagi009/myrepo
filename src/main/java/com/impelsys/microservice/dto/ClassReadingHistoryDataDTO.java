...
public class ClassReadingHistoryDataDTO {
    ...
    public ClassReadingHistoryDataDTO(Long studentId, String letterLevel, String lastPassage, String category, BigDecimal accuracy, String proficiency, Integer fluency, Date assignmentDate, String notes) {
